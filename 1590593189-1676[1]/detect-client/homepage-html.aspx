...
Sub Page_Load()
  ...
  If Request.QueryString("script") = "yes" Then
...
<html>
<head>
<title>Generic HTML 3.2 Page</title>
<style type="text/css">
body,td {font-family:Tahoma,Arial,sans-serif; font-size:10pt}
.bigtext {font-family:Tahoma,Arial,sans-serif; font-size:14pt}
</style>
</head>
<body>
<center><a href="http://www.w3c.org"><img src="html.jpg" border="0"/></a></p>
 <table border="0" width="100%" cellspacing="10" cellpadding="10">
  <tr bgcolor="#8b008b" align="center">
  <td class="bigtext" bgcolor="#8b008b" align="center">
  <font size="4" face="Tahoma,Arial,sans-serif" color="#dcdcdc">
  <b>Generic Page for HTML 3.2 Clients</b></font></td></tr>
 </table>
</center>
